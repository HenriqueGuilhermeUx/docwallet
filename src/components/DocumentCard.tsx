...
export const DocumentCard: React.FC<DocumentCardProps> = ({ document, onClick }) => {
  ...
  return (
    <button
      onClick={onClick}
      className="group bg-white rounded-xl shadow-card border border-slate-100 overflow-hidden text-left w-full transition-all duration-200 hover:shadow-card-hover hover:scale-[1.02] hover:border-primary/30 active:scale-[0.98]"
    >
